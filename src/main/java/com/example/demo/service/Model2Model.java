...
public class Model2Model {
    ...
    public void loadFiles()
    {
        ...
        configCode = FileReader.readFile("static/uploads/configFile.emf");
        dockerCompose = FileReader.readFile("static/uploads/docker-compose.emf");
        transformation = FileReader.readFile("static/uploads/Config2Docker.etl");
    }
}